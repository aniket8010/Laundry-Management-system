        ...
        <div className="row">
          ...
          <div className="col-12 col-lg-6 logo ml-4">
            <div style={{ display: "flex", alignItems: "center", justifyContent: "start" }}>
              ...
              <h5 className="pt-2 mt-2" style={{ fontFamily: "All Round Gothic" }}>Rutuja Drycleaners</h5>
            </div>
          </div>
                  ...
                  <li>
                    {isLoggedIn ? (
                      <div className="profile-dropdown">
                        <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="Profile" className="profile-icon" />
